    ...
    <div class="card shadow-sm rounded-4">
      <div class="card-body">
        <div class="d-flex justify-content-between mb-3">
          <h4>{{ t('distric.title') }}</h4>
          <button class="btn btn-success" @click="openCreateModal">
            <i class="fa-solid fa-circle-plus"></i> {{ t('distric.createButton') }}
          </button>
        </div>
              ...
              <tr v-for="(d, index) in districts" :key="d.id || index">
                ...
                <td class="text-end">
                  <button class="btn btn-sm btn-primary me-2" @click="openEditModal(d)">
                    <i class="fa-solid fa-pen-to-square"></i> {{ t('distric.edit') }}
                  </button>
                  <button class="btn btn-sm btn-danger" @click="askDelete(d)">
                    <i class="fa-solid fa-trash"></i> {{ t('distric.delete') }}
                  </button>
                </td>
              </tr>
            ...
            <form @submit.prevent="editMode ? updateDistrict() : createDistrict()">
              ...
              <div class="modal-footer border-0 px-0 mt-4 justify-content-end gap-2">
                ...
                <button v-if="!editMode" type="submit" class="btn btn-success btn-action px-4">
                  <i class="fa-solid fa-check me-1"></i> {{ t('distric.save') }}
                </button>

                <button v-else type="submit" class="btn btn-primary btn-action px-4">
                  <i class="fa-solid fa-check me-1"></i> {{ t('distric.update') }}
                </button>
              </div>
            </form>
          </div>
  ...
  methods: {
    ...
    async confirmDelete() {
      ...
      try {
        ...
        this.districts = this.districts.filter((d) => d.id !== this.deleteTarget.id)
